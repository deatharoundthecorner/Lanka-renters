...
class CustomerController
{
    ...
    public function dashboard(): array
    {
        ...
        $data['dashboard'] = [
            ...
            'progress' => [
                ['label' => 'Booking requested', 'description' => 'Your rental request has been submitted.', 'state' => 'complete'],
                ['label' => 'Owner accepted', 'description' => 'The vehicle owner has accepted the request.', 'state' => 'complete'],
                ['label' => 'Inspection uploaded', 'description' => 'The pre-rental inspection report is shared.', 'state' => 'complete'],
                ['label' => 'Customer confirmed inspection', 'description' => 'You have reviewed and accepted the inspection.', 'state' => 'complete'],
                ['label' => 'Payment uploaded', 'description' => 'Your payment proof has been attached.', 'state' => 'complete'],
                ['label' => 'Admin verified payment', 'description' => 'The payment has been confirmed by an administrator.', 'state' => 'complete'],
                ['label' => 'Rental active', 'description' => 'The rental period is currently in progress.', 'state' => 'current'],
                ['label' => 'Return inspection', 'description' => 'Complete the vehicle handover inspection.', 'state' => 'upcoming'],
                ['label' => 'Settlement completed', 'description' => 'Your final refund or settlement will be recorded.', 'state' => 'upcoming'],
            ],
            'recent_booking' => null,
            'quick_links' => [
